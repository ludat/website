...
- **Megaparsec: lo que las Regex quieren ser cuando sean grandes** — Introducción a parser combinators con Megaparsec. (HaskellBA)
- **Haskell en el frontend: FRP con reflex** — Programación funcional reactiva con Reflex. (HaskellBA)
- **Evaluando Javascript en Haskell** — Programación funcional reactiva con Reflex. (HaskellBA)
- **Haskell en Producción** — Usando Haskell en producción con la app de la Calculadora de Ganancias. (PdeP — UTN)
- **UIs funcionales con Elm** — Integrando un lenguaje funcional para construir interfaces de usuario usando Elm. (PdeP — UTN)
